...
from models.cast.cast_enc import SpotGuidedGeoTransformer_b2 as SpotGuidedGeoTransformer
...
# b2: consistency-aware self-attention -> all-to-anchor self-attention w/o RoPE
