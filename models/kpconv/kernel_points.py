...
def load_kernels(radius, num_kpoints, dimension, fixed, lloyd=False, scale=0.01):
    # Kernel directory
    ...
    # Add a small noise
    kernel_points = kernel_points + np.random.normal(scale=scale, size=kernel_points.shape)
    # Scale kernels
