...
class Trainer(StepBasedTrainer):
    def __init__(self, cfg, **kwargs):
        ...
        self.test_loader = DataLoader(test_dataset, 1, num_workers=cfg.num_workers, shuffle=False, pin_memory=True)
...
if __name__ == "__main__":
    ...
    with open(_args.config, 'r') as f:
        cfg = json.load(f)
        cfg = munchify(cfg)
    cfg.num_inference_steps = _args.steps
